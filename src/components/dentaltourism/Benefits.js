    ...
    return(
        <div>
            <div className="container">
                ...
                <div className="row upper-padding justify-content-around  align-items-center">
                    <div className="col-lg-6 col-md-8">
                        <h2 className="theme-dark size-16" style={{fontWeight:"700"}}>
                        Affordability
                        </h2>
                        <p className="decent-pad size-16" style={{fontWeight:"400",lineHeight:"20px",color:"black"}}>
                ...
                <div className="row upper-padding justify-content-around  align-items-center">
                    ...
                    <div className="col-lg-6 col-md-8" style={{paddingTop:"20px"}}>
                        <h2 className="theme-dark size-16" style={{fontWeight:"700"}}>
                        Quality Care
                        </h2>
                        <p className="decent-pad size-16" style={{fontWeight:"400",lineHeight:"20px",color:"black"}}>
