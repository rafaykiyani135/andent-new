            ...
            <div className="container">
                ...
                <div className="col-lg-2 col-md-6 d-flex justify-content-center">
                    <div className="fadeInUp animated" data-animation="fadeInUp" data-delay=".4s" >
                        ...
                        <img src={w1} alt="dt1" style={{height:"200px",width:"400px"}} className='img-fluid'/>
                        </div>
                ...
                <div className="col-lg-2 col-md-6 d-flex justify-content-center">
                    <div className="fadeInUp animated" data-animation="fadeInUp" data-delay=".4s" >
                        <div className='d-flex justify-content-start upper-padding'>
                        <img src={w2} alt="dt1" style={{height:"200px",width:"400px"}} className='img-fluid'/>
                        </div>
                        <div style={{paddingTop:"20px"}}>
                ...
                <div className="col-lg-2 col-md-6 d-flex justify-content-center">
                    <div className="fadeInUp animated" data-animation="fadeInUp" data-delay=".4s" >
                        <div className='d-flex justify-content-start upper-padding'>
                        <img src={w3} alt="dt1" style={{height:"200px",width:"400px"}} className='img-fluid'/>
                        </div>
                        <div style={{paddingTop:"20px"}}>
                ...
                <div className="col-lg-2 col-md-6 d-flex justify-content-center">
                    <div className="fadeInUp animated" data-animation="fadeInUp" data-delay=".4s" >
                        <div className='d-flex justify-content-start upper-padding'>
                        <img src={w4} alt="dt1" style={{height:"200px",width:"400px"}} className='img-fluid'/>
                        </div>
