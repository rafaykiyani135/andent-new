            ...
            <div className='row justify-content-center text-center'>
                ...
                <div className="row justify-content-center">
                    <div className="col-lg-5 col-md-10 col-sm-10 text-start text-md-center" >
                        <img src={img1} alt='dbimg' className='img-fluid' style={{height:"auto",width:"402px"}}/>
                    </div>
                ...
                <div className="row justify-content-center">
                <div className="col-lg-5 col-md-10 col-sm-10 text-start text-md-center order-md-first" style={{}}>
                        <img src={img2} alt='dbimg' className='' style={{height:"auto",width:"476px"}}/>
                </div>
